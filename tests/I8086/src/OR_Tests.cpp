...
class I8086_OR_Fixture : public I8086_TestFixture {
public:
...
TEST_F(I8086_OR_Fixture, OR_AL_Ib_Test1) {
    OR_CanDo_OR_AI<BYTE>(0x11, 0x22);
}

TEST_F(I8086_OR_Fixture, OR_AL_Ib_Test2) {
    OR_CanDo_OR_AI<BYTE>(0x10, 0x01);
}

TEST_F(I8086_OR_Fixture, OR_AL_Ib_Test3) {
    OR_CanDo_OR_AI<BYTE>(0x00, 0x00);
}

TEST_F(I8086_OR_Fixture, OR_AL_Ib_Test4) {
    OR_CanDo_OR_AI<BYTE>(0xFF, 0xFF);
}

TEST_F(I8086_OR_Fixture, OR_AL_Ib_Test5) {
    OR_CanDo_OR_AI<BYTE>(0xFF, 0x00);
}

TEST_F(I8086_OR_Fixture, OR_AL_Iv_Test1) {
    OR_CanDo_OR_AI<WORD>(0x1111, 0x2222);
}

TEST_F(I8086_OR_Fixture, OR_AL_Iv_Test2) {
    OR_CanDo_OR_AI<WORD>(0x1010, 0x0101);
}

TEST_F(I8086_OR_Fixture, OR_AL_Iv_Test3) {
    OR_CanDo_OR_AI<WORD>(0x0000, 0x0000);
}

TEST_F(I8086_OR_Fixture, OR_AL_Iv_Test4) {
    OR_CanDo_OR_AI<WORD>(0xFFFF, 0xFFFF);
}

TEST_F(I8086_OR_Fixture, OR_AL_Iv_Test5) {
