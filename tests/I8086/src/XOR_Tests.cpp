...
TEST_F(I8086_XOR_Fixture, XOR_Ev_Gv_BX_Addressed_AX) {
    ...
    TestMemRegInstruction(memAddress, memValue, refValue, XOR_Ev_Gv, modReg, 16);
}
...
TEST_F(I8086_XOR_Fixture, XOR_Gv_Ev_AX_BX) {
    ...
    TestRegRegInstruction(&cpu.AX, &cpu.BX, refValue, &leftReg, &rightReg, XOR_Gv_Ev, 16);
}
...
TEST_F(I8086_XOR_Fixture, XOR_Gv_Ev_BX_DI) {
    ...
    TestRegRegInstruction(&cpu.BX, &cpu.DI, refValue, &leftReg, &rightReg, XOR_Gv_Ev, 16);
}
...
TEST_F(I8086_XOR_Fixture, XOR_Gb_Eb_AL_BH) {
    ...
    TestRegRegInstruction(&cpu.AL, &cpu.BH, refValue, &leftReg, &rightReg, XOR_Gb_Eb, 16);
}
...
TEST_F(I8086_XOR_Fixture, XOR_Gb_Eb_BL_CL) {
    ...
    TestRegRegInstruction(&cpu.BL, &cpu.CL, refValue, &leftReg, &rightReg, XOR_Gb_Eb, 16);
}
