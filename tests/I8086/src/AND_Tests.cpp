...
class I8086_ANDFixture : public I8086_TestFixture {
public:
...
TEST_F(I8086_ANDFixture, AND_Ev_Gv_BX_Addressed_AX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_ANDFixture, AND_Ev_Gv_Direct_Addressed_BX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_ANDFixture, AND_Ev_Gv_BP_Addressed_WithDisp_DX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_ANDFixture, AND_Ev_Gv_BXSI_Addressed_WithDisp_AX) {
    ModRegByteConstructor modReg;
...
// AX <-- AX & BX
TEST_F(I8086_ANDFixture, AND_Gv_Ev_AX_BX) {
    cpu.AX = 0x0060;
    cpu.BX = 0x009A;
...
// BX <-- BX & DI
TEST_F(I8086_ANDFixture, AND_Gv_Ev_BX_DI) {
    cpu.BX = 0x0060;
    cpu.DI = 0x009A;
...
// AL <-- AL & BH
TEST_F(I8086_ANDFixture, AND_Gb_Eb_AL_BH) {
    cpu.AL = 0x60;
    cpu.BH = 0x9A;
...
// BL <-- BL & CL
TEST_F(I8086_ANDFixture, AND_Gb_Eb_BL_CL) {
    cpu.BL = 0x0060;
    cpu.CL = 0x009A;
...
TEST_F(I8086_ANDFixture, AND_AL_Ib_Test1) {
    AND_CanDo_AND_AI<BYTE>(0x11, 0x22);
}

TEST_F(I8086_ANDFixture, AND_AL_Ib_Test2) {
    AND_CanDo_AND_AI<BYTE>(0x10, 0x01);
}

TEST_F(I8086_ANDFixture, AND_AL_Ib_Test3) {
    AND_CanDo_AND_AI<BYTE>(0x00, 0x00);
}

TEST_F(I8086_ANDFixture, AND_AL_Ib_Test4) {
    AND_CanDo_AND_AI<BYTE>(0xFF, 0xFF);
}

TEST_F(I8086_ANDFixture, AND_AL_Ib_Test5) {
    AND_CanDo_AND_AI<BYTE>(0xFF, 0x00);
}

TEST_F(I8086_ANDFixture, AND_AL_Iv_Test1) {
    AND_CanDo_AND_AI<WORD>(0x1111, 0x2222);
}

TEST_F(I8086_ANDFixture, AND_AL_Iv_Test2) {
    AND_CanDo_AND_AI<WORD>(0x1010, 0x0101);
}

TEST_F(I8086_ANDFixture, AND_AL_Iv_Test3) {
    AND_CanDo_AND_AI<WORD>(0x0000, 0x0000);
}

TEST_F(I8086_ANDFixture, AND_AL_Iv_Test4) {
    AND_CanDo_AND_AI<WORD>(0xFFFF, 0xFFFF);
}

TEST_F(I8086_ANDFixture, AND_AL_Iv_Test5) {
